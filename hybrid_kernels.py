...
from scene import STRUCT_BEAM, STRUCT_COLUMN, STRUCT_CORE, STRUCT_GLASS
...
def count_loaded_building_particles(
    ...
    if kind[i] != 0 and bid >= 0:
        ...
        if wp.length(solid_force[i]) > threshold:
    ...
    for j in query:
        ...
        if bonded and same_fragment:
            ...
            if abs_strain > limit and crack_front:
                ...
                increment = wp.min(normalized * dt * damage_rate, max_damage_per_substep)
