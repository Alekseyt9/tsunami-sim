...
class DelugeSolver:
    def __init__(self, cfg: dict, output: Path, resume: Path | None = None):
        ...
        # The structural kernel also needs the face-diagonal neighbours used
        # for shear stiffness.  Hash-grid query radius must not clip them.
        solid_support = float(cfg["solid_spacing"]) * 1.8
